...
const themeIcons = { dark: "☾", light: "☀", sepia: "◐" };

export function ReaderHeader({ hasFile, theme, onThemeChange, onOpenFile }: ReaderHeaderProps) {
  return (
    <header className="topbar">
      <div className="brand"><div className="brand-mark"><span>N</span></div><div className="brand-text"><strong>NightReader</strong><span>PDF Reader</span></div></div>
